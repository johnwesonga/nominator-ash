...
config :nominator, NominatorWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: NominatorWeb.ErrorHTML, json: NominatorWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Nominator.PubSub,
  live_view: [signing_salt: "ZcsmljJa"]
...
config :nominator, Nominator.Mailer, adapter: Swoosh.Adapters.Local
